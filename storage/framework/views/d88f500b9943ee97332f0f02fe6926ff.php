...
<div class="container-fluid px-4 py-4" style="max-width: 1600px; margin: 0 auto;">
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4" id="adminCarePlantsGrid">
        ...
        <div class="col admin-care-plant-item" 
             ...
             data-name="<?php echo e(strtolower($plant->name)); ?>"
             data-status="<?php echo e($plant->has_care_info ? 'complete' : 'missing'); ?>">
            <div class="admin-plant-card">
                ...
                <div class="card-body">
                    ...
                    <div class="scientific-name-container">
                        <?php if($plant->scientific_name): ?>
                            <p class="scientific-name"><?php echo e($plant->scientific_name); ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="mb-2">
                        <span class="category-badge"><?php echo e(ucfirst($plant->category)); ?></span>
                        <?php if($plant->code): ?>
                            <span class="code-badge"><?php echo e($plant->code); ?></span>
                        <?php endif; ?>
                    </div>
                ...
                <div class="card-footer">
                    <a href="<?php echo e(route('plant-care.edit', ['id' => $plant->id, 'from' => 'admin'])); ?>" class="edit-care-btn">
                        <i class="fas fa-edit me-2"></i><?php echo e($plant->has_care_info ? 'Edit' : 'Add'); ?> Care Info
                    </a>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODING\my_Inventory\resources\views/plant-care/admin-index.blade.php ENDPATH**/ ?>