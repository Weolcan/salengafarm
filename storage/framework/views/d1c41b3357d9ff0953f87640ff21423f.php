    ...
    <div class="min-h-screen">
        <div class="login-container position-relative">
            <div class="max-w-md bg-white rounded-3xl shadow-2xl p-2">
                ...
                <form class="space-y-2" method="POST" action="<?php echo e(route('register')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mt-4 flex justify-between items-center">
                        <p class="text-sm text-gray-600">
                            ...
                            <a href="<?php echo e(route('login')); ?>" class="text-primary hover:text-primary-dark">Sign In</a>
                        </p>
                    </div>
                </form>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\CODING\my_Inventory\resources\views/auth/register.blade.php ENDPATH**/ ?>