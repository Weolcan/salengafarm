...
<head>
    ...
    <link href="<?php echo e(asset('css/profile.css')); ?>?v=1" rel="stylesheet">
                    ...
                    <div class="card-body text-center">
                        <div class="profile-pic-container" id="profilePicContainer">
                            <?php if(auth()->user()->avatar): ?>
                                <img src="<?php echo e(asset('storage/' . auth()->user()->avatar)); ?>" alt="Profile Picture" class="profile-pic" id="previewImage">
                            <?php else: ?>
                        ...
                        <form method="post" action="<?php echo e(route('profile.update')); ?>" class="space-y-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    ?>
                                    <span class="badge <?php echo e($badgeColor); ?> fs-6"><?php echo e($roleDisplay); ?></span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" name="email" 
                                       value="<?php echo e(old('email', auth()->user()->email)); ?>" required readonly 
            ...
            <div class="col-12">
                <div class="profile-card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="<?php echo e(route('password.update')); ?>" id="passwordForm">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('put'); ?>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODING\my_Inventory\resources\views/profile/edit.blade.php ENDPATH**/ ?>