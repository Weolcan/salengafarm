...
<?php $__env->startSection('title', 'Inquiry Response - Salenga Farm'); ?>
...
<div class="response-container">
    <div class="response-header">
        <h4 class="response-title">
            ...
            <?php if($request->request_type === 'client'): ?>
                RFQ Response #<?php echo e($request->id); ?>

            <?php else: ?>
                Inquiry Response #<?php echo e($request->id); ?>

            <?php endif; ?>
        </h4>
        <div class="header-actions">
            <?php if($request->request_type === 'client' && $request->pdf_path): ?>
                <a href="<?php echo e(route('requests.download-pdf', $request->id)); ?>" class="download-btn">
                    <i class="fas fa-download"></i>Download RFQ
                </a>
            <?php endif; ?>
            <a href="<?php echo e(route('dashboard.user')); ?>" class="back-btn">
    ...
    <div class="info-card">
        ...
        <div class="info-card-body">
            <div class="info-grid">
                <div class="info-item">
                    <strong>Inquiry Date:</strong> <?php echo e($request->created_at->format('M d, Y')); ?>

                </div>
                <div class="info-item">
                    <strong>Response Date:</strong> <?php echo e($request->response_sent_at ? $request->response_sent_at->format('M d, Y') : 'N/A'); ?>
                ...
                <?php if($respondedBy): ?>
                <div class="info-item">
                    <strong>Responded By:</strong> <?php echo e($respondedBy->name); ?>
                ...
                <table class="plant-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="plant-name"><?php echo e($item['plant_name'] ?? $item['name'] ?? 'N/A'); ?></td>
                            <td><?php echo e($item['quantity'] ?? 0); ?></td>
                            <td><?php echo e($item['height_mm'] ?? $item['height'] ?? 'N/A'); ?></td>
                            <td><?php echo e($item['spread_mm'] ?? $item['spread'] ?? 'N/A'); ?></td>
                            <td><?php echo e($item['spacing_mm'] ?? $item['spacing'] ?? 'N/A'); ?></td>
                            <td>
                                <?php
                                ...
                                <?php else: ?>
                                    <span class="avail-badge avail-secondary"><?php echo e($availability); ?></span>
                                <?php endif; ?>
                            </td>
                            <?php if($request->request_type === 'client'): ?>
                            <td class="price-col">
                            ...
                            <?php endif; ?>
                            <td class="remarks">
                                <?php echo e(!empty($item['remarks']) ? $item['remarks'] : '—'); ?>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODING\my_Inventory\resources\views/user/inquiry-response.blade.php ENDPATH**/ ?>