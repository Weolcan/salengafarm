            ...
            <div class="collapse navbar-collapse" id="navbarMain">
                ...
                <div class="user-section d-flex align-items-center">
                    ...
                    <div class="dropdown">
                            ...
                            <li>
                                    <a class="dropdown-item" href="<?php echo e(route('profile.edit')); ?>" style="font-size: 0.95rem; padding: 6px 14px;">
    ...
    <div class="container-fluid py-5">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6 text-end search-controls-container">
                    ...
                    <?php elseif(Auth::check() && Auth::user()->role === 'user' && !Auth::user()->is_client): ?>
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="plant-details-panel">
                                        ...
                                        <div class="details-header d-flex justify-content-between align-items-center p-2 text-white">
                                            ...
                                            <?php if(Auth::check() && Auth::user()->role === 'user' && !Auth::user()->is_client): ?>
                                                <div class="d-flex gap-2 align-items-center">
                                                    <button type="button" class="btn btn-sm btn-success plant-action-btn"
                                                            data-plant-id="<?php echo e($plant->id); ?>"
                                                            data-plant-name="<?php echo e($plant->name); ?>"
                                                            data-plant-code="<?php echo e($plant->code); ?>"
                                                            data-height="<?php echo e($plant->height_mm); ?>"
                                                            data-spread="<?php echo e($plant->spread_mm); ?>"
                                                            data-spacing="<?php echo e($plant->spacing_mm); ?>"
                                                            data-action="add"
