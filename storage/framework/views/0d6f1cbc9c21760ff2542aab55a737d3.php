...
<head>
    ...
    <title>Inventory - Salenga Farm</title>
...
<body class="bg-light inventory-page">
                    ...
                    <tbody id="plantsTableBody">
                        <?php $__currentLoopData = $plants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="plant-row" 
                                ...
                                <td><?php echo e($plant->quantity > 0 ? 'In Stock' : 'Out of Stock'); ?></td>
                                <td><?php echo e($plant->height_mm); ?></td>
                                <td><?php echo e($plant->spread_mm); ?></td>
                            ...
                            <tr class="details-row d-none" id="details-<?php echo e($plant->id); ?>">
                                <td colspan="6">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="mb-2">
                                                                ...
                                                                <div><?php echo e($plant->name); ?></div>
                                                            </div>
                                                            <div class="mb-2">
                                                                <label class="text-muted">Code:</label>
                                                                <div><?php echo e($plant->code); ?></div>
                                                            </div>
                                                            <div class="mb-2">
                                                                <label class="text-muted">Scientific Name:</label>
                                                                <div><?php echo e($plant->scientific_name); ?></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="mb-2">
                                                                ...
                                                                <div>₱<?php echo e(number_format($plant->price, 2)); ?></div>
                                                            </div>
                                                            <div class="mb-2">
                                                                <label class="text-muted">Quantity:</label>
                                                                <div><?php echo e($plant->quantity); ?></div>
                                                            </div>
                                                            <div class="mb-2">
                                                                <label class="text-muted">Category:</label>
                                                                <div><?php echo e(ucfirst($plant->category)); ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="mb-2">
                                                                ...
                                                                <div><?php echo e($plant->height_mm); ?></div>
                                                            </div>
                                                            <div class="mb-2">
                                                                <label class="text-muted">Spread (mm):</label>
                                                                <div><?php echo e($plant->spread_mm); ?></div>
                                                            </div>
                                                            <div class="mb-2">
                                                                <label class="text-muted">Spacing (mm):</label>
                                                                <div><?php echo e($plant->spacing_mm); ?></div>
                                                            </div>
                                                            <div class="mb-2">
                                                                <label class="text-muted">OC:</label>
                                                                <div><?php echo e($plant->oc); ?></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="mb-2">
                                                                ...
                                                                <div>₱<?php echo e(number_format($plant->cost_per_sqm, 2)); ?></div>
                                                            </div>
                                                            <div class="mb-2">
                                                                <label class="text-muted">No. PCS per SQM:</label>
                                                                <div><?php echo e($plant->pieces_per_sqm); ?></div>
                                                            </div>
                                                            <div class="mb-2">
                                                                <label class="text-muted">Cost per MM:</label>
                                                                <div>₱<?php echo e(number_format($plant->cost_per_mm, 2)); ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        let additionalCategories = <?php echo json_encode($categories ?? [], 15, 512) ?>;
        ...
        $('#confirmDeleteCategoryBtn').on('click', function() {
            if (selectedCategoryToDelete) {
                ...
                $.ajax({
                    url: '<?php echo e(url("categories")); ?>/' + selectedCategoryToDelete,
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
...
</html> <?php /**PATH C:\CODING\my_Inventory\resources\views/plants/index.blade.php ENDPATH**/ ?>