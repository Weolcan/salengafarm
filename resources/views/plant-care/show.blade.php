...
<div class="container-fluid px-4 py-4" style="max-width: 1400px; margin: 0 auto;">
    ...
    <div class="mb-4 d-flex gap-2">
        <a href="{{ route('plant-care.index') }}" class="back-button">
            <i class="fas fa-arrow-left me-2"></i>Back to Library
        </a>
        @if(auth()->check() && auth()->user()->role === 'admin')
            <a href="{{ route('plant-care.edit', $plant->id) }}" class="edit-button">
    ...
    <div class="plant-care-hero">
        <div class="row align-items-center">
            ...
            <div class="col-md-8">
                <h1 class="display-4 fw-bold mb-2">{{ $plant->name }}</h1>
                @if($plant->scientific_name)
                    <p class="fs-5 mb-3" style="opacity: 0.9;"><em>{{ $plant->scientific_name }}</em></p>
                @endif
                <span class="category-badge">
                    <i class="fas fa-tag me-2"></i>{{ ucfirst($plant->category) }}
                </span>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="care-card">
                    <div class="card-body">
                        ...
                        <h5>Temperature</h5>
                        <p>{{ $plant->care_temperature }}</p>
                    </div>
                </div>
            </div>
            @endif

            @if($plant->care_humidity)
            <div class="col-md-6 col-lg-4">
                <div class="care-card">
                    <div class="card-body">
                        ...
                        <h5>Humidity</h5>
                        <p>{{ $plant->care_humidity }}</p>
                    </div>
                </div>
            </div>
            @endif

            @if($plant->care_fertilizing)
            <div class="col-md-6 col-lg-4">
                <div class="care-card">
                    <div class="card-body">
                        ...
                        <h5>Fertilizing</h5>
                        <p>{{ $plant->care_fertilizing }}</p>
                    </div>
                </div>
            </div>
            @endif

            @if($plant->care_pruning)
            <div class="col-md-6 col-lg-4">
                <div class="care-card">
                    <div class="card-body">
                        ...
                        <h5>Pruning</h5>
                        <p>{{ $plant->care_pruning }}</p>
                    </div>
                </div>
            </div>
            @endif

            @if($plant->care_propagation)
            <div class="col-md-6 col-lg-4">
                <div class="care-card">
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="care-card">
                    <div class="card-body">
                        ...
                        <p>{{ $plant->care_pests }}</p>
                    </div>
                </div>
            </div>
            @endif

            @if($plant->care_growth_rate)
            <div class="col-md-6 col-lg-4">
                <div class="care-card">
                    <div class="card-body">
                        ...
                        <h5>Growth Rate</h5>
                        <p>{{ $plant->care_growth_rate }}</p>
                    </div>
                </div>
            </div>
            @endif

            @if($plant->care_toxicity)
            <div class="col-md-12">
