...
<body>
    <div class="document">
        ...
        <table>
            <tr>
                <td><strong>RFQ DATE:</strong> {{ $request->request_date->format('F d, Y') }}</td>
                <td><strong>RFQ Due Date:</strong> {{ $request->due_date->format('F d, Y') }}</td>
            </tr>
        </table>

        <table>
            <tr>
                <td><strong>Buyer Name:</strong> {{ $request->name }}</td>
                <td><strong>Buyer Email:</strong> {{ $request->email }}</td>
            </tr>
        </table>
        ...
        <div class="footer">
            ...
            <p>RFQ ID: {{ $request->id }} | Generated on: {{ now()->format('F d, Y H:i:s') }}</p>
        </div>
    </div>
</body>
</html> 